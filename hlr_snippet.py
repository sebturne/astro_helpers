...
raw_data = N.genfromtxt('id_z_mstar_smdust_ssfr_hlr_bt.txt', delimiter = ',')
...
for i in range(N.shape(raw_data)[0]):
	Eint = SI.quad(Einv, 0, raw_data[i,1])
